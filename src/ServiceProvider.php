...
namespace munchy\ReportGenerator;

use Illuminate\Support\Str;
use munchy\ReportGenerator\ReportMedia\CSVReport;
use munchy\ReportGenerator\ReportMedia\PdfReport;
use munchy\ReportGenerator\ReportMedia\ExcelReport;
...
class ServiceProvider extends IlluminateServiceProvider
{
    ...
    protected function registerAliases()
    {
        if (class_exists('Illuminate\Foundation\AliasLoader')) {
            ...
            $loader->alias('PdfReport', \munchy\ReportGenerator\Facades\PdfReportFacade::class);
            $loader->alias('ExcelReport', \munchy\ReportGenerator\Facades\ExcelReportFacade::class);
            $loader->alias('CSVReport', \munchy\ReportGenerator\Facades\CSVReportFacade::class);
        }
    }
